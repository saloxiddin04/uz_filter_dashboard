...
const Dashboard = () => {
  ...
  const dataUserCount = [
    {label: 'Распроданный', value: 20, color: colors[0]},
    {label: 'Остальные', value: 50, color: colors[3]}
  ];
  
  const dataProducts = [
    {label: 'Готовый продукт', value: 1000, color: colors[2]},
